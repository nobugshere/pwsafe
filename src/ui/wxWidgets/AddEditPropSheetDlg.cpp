...
void AddEditPropSheetDlg::InitializeExpTimes()
{
  ...
  // Some entries, created with recent versions of pwsafe, might have an interval but no date,
  // which is interpreted as "Never".  We are going to ignore it and use the user set default.
  // If an expiry change is made, the entry will be re-written correctly.
